...
(:action setup-orientacion ;Cambia la orientacion de la pieza
 :parameters ( ?orientacion-inicial ?orientacion-final )
 :precondition
	(and 
        (orientacion-pieza ?orientacion-inicial)
        (orientacion ?orientacion-inicial) ;En las precondiciones se indican que clase de datos se introducen en los parametros
